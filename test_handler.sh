...
pip3.11 install --trusted-host nexus.inps.it --index-url=http://nexus.inps.it/repository/python-group/simple --upgrade pip==23.3.2
pip3.11 install -vvv --trusted-host nexus.inps.it --index-url=http://nexus.inps.it/repository/python-group/simple -r requirements-test.txt
