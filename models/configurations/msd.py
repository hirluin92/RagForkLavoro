...
class MsdSettings(BaseSettings):
    ...
    no_spec_form_app_show_list: str = "Mi dispiace, ma dopo un'attenta verifica, purtroppo non sono riuscito a trovare alcuna domanda corrispondente ai tuoi criteri nei nostri sistemi. In compenso posso mostrarti le seguenti domande: "
    no_spec_form_app_show_text: str = "Mi dispiace, ma dopo un'attenta verifica, purtroppo non sono riuscito a trovare alcuna domanda corrispondente ai tuoi criteri nei nostri sistemi. In compenso posso dirti che:"