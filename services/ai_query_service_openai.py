...
class AiQueryServiceOpenAI(AiQueryServiceBase):
    ...
    async def a_do_query_enrichment(
        self,
        ...
        query_enrichment_result = await a_get_enriched_query(
            request.query, topic, chat_history, prompt_data, logger, consumer
        )
    ...
    async def a_do_query(
        ...
        query_result = await a_execute_query(request, prompt_data, logger, session, consumer, domusData)
        return query_result

    async def a_compute_classify_intent_query(
        self,
        request: RagOrchestratorRequest,
        prompt_data: PromptEditorResponseBody,
        logger: Logger,
        ...
        result = await a_get_intent_from_enriched_query(request.query, prompt_data, logger, consumer)
        return result

    async def a_get_domus_answer(
        self,
        request: RagOrchestratorRequest,
        practice_detail: str,
        prompt_data: PromptEditorResponseBody,
        ...
        result = await a_get_answer_from_domus(request.query, practice_detail, prompt_data, logger, consumer)
        return result
